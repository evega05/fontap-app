...
const s = StyleSheet.create({
  ...
  card: { flexDirection: 'row', alignItems: 'center', backgroundColor: colors.bgCard, borderRadius: 14, padding: 12, gap: 10, borderWidth: 1, borderColor: colors.border, marginBottom: 8, cursor: 'pointer' },
  ...
  btnWrap: { backgroundColor: colors.blue, borderRadius: 14, padding: 14, alignItems: 'center', cursor: 'pointer', marginTop: 4 },
